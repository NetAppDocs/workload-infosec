...
keywords: AWS account integration, sts:AssumeRole, IAM role, external ID, temporary credentials, cross-account access, confused deputy attack, role trust policy, onboarding
