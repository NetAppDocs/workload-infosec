...
You can opt out of Ask Me at any time through the Workload Factory *Administration* settings, which disables the assistant for your user account. link:https://docs.netapp.com/us-en/workload-setup-admin/manage-genai-features.html[Learn more about managing GenAI features.^]
