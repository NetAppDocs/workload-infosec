...
image:infosec-trust.png[Diagram showing how Workload Factory uses a trust relationship between a NetApp AWS account and customer AWS accounts with FSx for ONTAP file systems. (AssumeRole)]
