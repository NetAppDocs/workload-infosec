...
[.lead]
Workload Factory data handling is organized into categories that describe the operational data processed by the service and how each data class fits within the security model.
