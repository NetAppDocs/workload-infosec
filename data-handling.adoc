...
summary: "Workload Factory data handling is described using the following categories, configuration and metadata, operational logs and events, and telemetry."
---
...
[.lead]
Workload Factory data handling is described using the following categories:
...
** Retention: 14 days in DynamoDB (auto-deleted by TTL)
