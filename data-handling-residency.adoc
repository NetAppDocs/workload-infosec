...
xref:credential-retention.adoc[Credential retention for NetApp Workload Factory]
...
* xref:ai-controls-overview.adoc[AI controls overview for NetApp Workload Factory]
...
Refer to xref:connectivity-and-trust-paths.adoc[Connectivity and trust paths for NetApp Workload Factory].

=== Telemetry and metrics collection

Refer to xref:metrics-and-telemetry-reference.adoc[Metrics and telemetry reference for NetApp Workload Factory].
...
* Retention and storage details: xref:metrics-and-telemetry-reference.adoc[Metrics and telemetry reference for NetApp Workload Factory]