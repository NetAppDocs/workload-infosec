...
keywords: credential retention, AWS STS credentials, role metadata, external ID, credential expiration, Redis caching, credential deletion, retention duration
